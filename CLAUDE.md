...
The 15 tools fall into four groups: **reference** (`get_generation_guide`, `list_elements`, `get_element`,
...
**persistence** (`list_organizations`, `create_page`, `list_pages`, `find_pages`, `get_page`, `update_page`, `add_section` — need env).
